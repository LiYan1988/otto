...
for (z in tmpC) {
  print(z)
  tmpS1 = sample(trind,size=tmpL,replace=F) # what if replace is FALSE?
...
write.csv(pred,file='../ottoHomeBagG6sampleWithoutReplacement.csv', quote=FALSE,row.names=FALSE)